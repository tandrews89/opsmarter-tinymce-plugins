                    ...
                    editor.windowManager.open({
                        ...
                        onsubmit: function (_e) {
                            ...
                            for (i = 0; i < e.control.settings.fields.length; i++) {
                                value = value.replace('[' + e.control.settings.fields[i].name + ']', _e.data[e.control.settings.fields[i].name])
                            }

                            // Set the content
                            editor.execCommand("mceInsertContent", false, value + tinymce.signature);
                        }
                    });
                }
            }
