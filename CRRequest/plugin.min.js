    ...
    editor.addButton('Messages', function () {
        return {
            ...
            values: [{
                ...
                text: 'Basic First Contact',
                value: 'Hi [CLIENT_NAME],<br><br>Thank you for contacting Blackboard Technical Support.<br><br>',
                fields: [{
                    type: 'textbox',
                    name: 'CLIENT_NAME',
                    size: 20,
                ...
                text: 'Collaborate Escalation',
                value: 'Hi [CLIENT_NAME],<br><br><br>Thank you for contacting Blackboard Technical Support. After looking into this issue I have determined it will require a member of our Tier 2 team to take over the case. After reviewing the case details a member of our Tier 2 Collaborate support team will follow up with you as soon as possible with any additional questions, a status update, or an immediate resolution. Please let us know if you have any questions or concerns.<br><br>',
                fields: [{
                    type: 'textbox',
                    name: 'CLIENT_NAME',
                    size: 20,
            ...
            onclick: function (e) {
                if (e.control.settings.value) {
                    editor.windowManager.open({
                        ...
                        body: e.control.settings.fields,
                        onsubmit: function (_e) {
                            // Loop through the fields and replace them.
                            for (i = 0; i < e.control.settings.fields.length; i++) {
                                e.control.settings.value = e.control.settings.value.replace('[' + e.control.settings.fields[i].name + ']', _e.data[e.control.settings.fields[i].name])
                            }

                            // Set the content
                            editor.execCommand("mceInsertContent", false, e.control.settings.value + tinymce.signature);
                        }
                    });
                }
            }
